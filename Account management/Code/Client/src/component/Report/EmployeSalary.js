...
export default function EmployeSalary() {
  ...
  const calattendenesalary = (id, att, ot) => {
    console.log(att);
    for (var i = 0; i < basic.length; i++) {
      if (basic[i].employeeId == id) {
        let tot = basic[i].basicSalary + ot - att * 1500;
        total += tot;
        return tot;
      }
    }
      ...
      <Container maxWidth="lg" className={classes.container}>
        <Box className={classes.box}>
          ...
          >
            ...
            <Typography>Monthly Employee Salary Report</Typography>
          </Stack>
          <Stack direction="row" spacing={2} justifyContent="center">
                ...
                {isSuccess &&
                  ...
                  rows.map((row, index) => (
                    ...
                    >
                      ...
                      <TableCell>
                        {numberWithCommas(otsalaryCal(row.OTHours))}
                      </TableCell>
                      <TableCell align="right">
                        {numberWithCommas(
                          calattendenesalary(
            ...
            <Stack direction="row" justifyContent={"flex-end"} spacing={2}>
              {total != 0 && (
                <Typography
                  ...
                  sx={{ marginLeft: "40px" }}
                >
                  Total Salary Pay-: {numberWithCommas(total)}
                </Typography>
              )}
            </Stack>
          </Box>
